<!-- Header -->
<header class="absolute inset-x-0 top-0 z-10 pt-3" style="background: linear-gradient(180deg, #000 46.41%, rgba(25, 24, 31, 0) 100%)">
    <div class="container">
        <nav class="flex items-center justify-between lg:gap-x-3 xl:gap-x-0 2xl:gap-x-3">
            <figure class="logo">
                <img src="{{ asset('images/logo.svg') }}" alt="Maxima" />
            </figure>

            <div class="navigation hidden lg:block">
                <ul class="mb-7 flex gap-x-4 font-montserrat_b text-sm">
                    <li class="transition-colors hover:text-accent-500">
                        <a href="/">{{ __('Home') }}</a>
                    </li>
                    <li class="transition-colors hover:text-accent-500">
                    ...
                    <li class="transition-colors hover:text-accent-500">
                        <a href="/">{{ __('Payment and delivery') }}</a>
                    </li>
                    <li class="transition-colors hover:text-accent-500">
    ...
    <div class="sidebar__panel bg-darkblue-500">
        <nav class="relative">
            <figure class="logo mb-9">
                <img src="{{ asset('images/logo.svg') }}" alt="Maxima" class="max-w-[100px]" />
            </figure>

            <ul class="sidebar__panel-nav fo font-montserrat_b">
                <li class="mb-7 text-base transition-colors hover:text-accent-500">
                    <a href="/">{{ __('Home') }}</a>
                </li>
                <li class="mb-7 text-base transition-colors hover:text-accent-500">
                    <a href="/">{{ __('Products') }}</a>
